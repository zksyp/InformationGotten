...
import com.zksyp.informationgotten.util.ActivityUtil;
import com.zksyp.informationgotten.util.EventUtil;
...
//        tv.setOnClickListener(listener);
    ...
    protected void setToolLeftImage(int resId) {
        ImageView iv = $(R.id.left_btn);
        iv.setImageResource(resId);
    }
